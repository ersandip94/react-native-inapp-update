        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_4 = _a.sent();
                        console.error('Error getting update prompt count:', error_4);
                        return [2 /*return*/, 0];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        console.error('Error incrementing update prompt count:', error_5);
                        return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(this.config.checkMajorVersion && current.major < latest.major)) return [3 /*break*/, 2];
